...
import './dashboard/support.dart';
import './dashboard/about.dart';
import './dashboard/faq.dart';
import './dashboard/feedback.dart';
import './dashboard/search.dart';
import './dashboard/address.dart';
import './dashboard/add_location.dart';
import './dashboard/product_detail.dart';
import './dashboard/cart.dart';
import './dashboard/checkout.dart';
import './dashboard/user_account.dart';
import './dashboard/order_history.dart';
import './dashboard/order_detail.dart';
import './dashboard/edit_profile.dart';
import './dashboard/update_pass.dart';
import './dashboard/promos.dart';

import './biker/index.dart';
import './biker/biker_orders.dart';
import './biker/biker_order_detail.dart';

import './privacy_policy.dart';
import 'package:small_hurry/tnc.dart';
...
void main() async{
  ...
  FirebaseMessaging.instance.getToken().then((token) {
    if(token != null){
      globals.fireToken=token;
    }
  });
  
  await AwesomeNotifications().initialize(
    "resource://drawable/noti_icon",
      [
        NotificationChannel(
            channelGroupKey: 'basic_channel_group',
            channelKey: 'basic_channel',
            channelName: 'Basic notifications',
            channelDescription: 'Notification channel for app basics',
            defaultColor: const Color(0xFF73AB22),
